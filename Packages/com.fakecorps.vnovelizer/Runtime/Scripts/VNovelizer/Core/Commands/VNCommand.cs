...
namespace VNovelizer.Core.Commands
{
    ...
    public class CommandManager : BaseManager<CommandManager>
    {
        ...
        // 命令管理器会询问所有正在执行的命令，只要其中任何一个要求锁住点击，就返回 true。
        // _runningCommandRefCount 的枚举项是 KeyValuePair，因此必须枚举 Keys。
        public bool BlockAdvanceInput => _runningCommandRefCount.Keys.Any(command => command != null && command.BlockAdvanceInput);
